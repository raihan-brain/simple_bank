...
const listOfTransfer = `-- name: ListOfTransfer :many
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
ORDER BY id
LIMIT $1
OFFSET $2
...
type ListOfTransferParams struct {
	Limit  int32 `json:"limit"`
	Offset int32 `json:"offset"`
}

func (q *Queries) ListOfTransfer(ctx context.Context, arg ListOfTransferParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, listOfTransfer, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
